    ...
    protected void doAction(Object param) {
        ...
        if ( GeneralAlert.RESULT_YES == GeneralAlert.showQuestion( NedResources.QUESTION_REMOVE_CONTENT ) ) {
            if(param instanceof List){
                ...
                if(uiList.getSelectedItem() instanceof Content){
                    Content content = (Content) uiList.getSelectedItem();
                    ...
                    NedLibrary selected = NedMidlet.getSettingsManager().getLibraryManager().findLibrary(content.getParentId());
                    if(selected != null){
