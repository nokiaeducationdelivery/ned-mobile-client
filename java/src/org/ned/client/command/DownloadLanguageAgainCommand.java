...
public class DownloadLanguageAgainCommand extends NedCommandAsync {

    private static DownloadLanguageAgainCommand instance;

    private DownloadLanguageAgainCommand() {
        command = new Command( NedResources.DOWNLOAD_AGAIN_LANGUAGE );
    }

    public static DownloadLanguageAgainCommand getInstance() {
        if ( instance == null ) {
            instance = new DownloadLanguageAgainCommand();
        }
        return instance;
    }
    ...
    protected void doAction( Object param ) {
        ...
        try {
            ...
            fc.rename( "messages_" + lang.getLocale() + ".properties" );
